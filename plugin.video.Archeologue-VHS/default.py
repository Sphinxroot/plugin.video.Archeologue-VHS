...
if mode==None:
	addDir('Archéologue VHS','plugin://plugin.video.youtube/channel/UCUfYICG1zAB2Y7-0vyNZGFQ ',1,'https://i.imgur.com/4aDhQ3U.png','')

else:
	Youtubechannel('UCUfYICG1zAB2Y7-0vyNZGFQ')
